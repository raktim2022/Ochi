...
function Footer() {
    const socialLinks = ["Instagram ", "Facebook", "Linkdin", "Behance", "Twitter"];
    const locationLinks = ["202-1965 W 4th Ave ", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"];
    ...
    return (
        <motion.div 
            ...
            viewport={{once: true}}
            className='w-full h-full p-20 flex justify-between'
        >
            <div className='w-1/2 h-screen relative'>
                <div className='heading overflow-hidden'>
                    <motion.h1 
                        ...
                        transition={{duration: 0.8}}
                        viewport={{once: true}}
                        className='text-8xl font-semibold uppercase leading-none -mb-3'
                    >
                        Eye-
                    </motion.h1>
                    <motion.h1 
                        ...
                        viewport={{once: true}}
                        className='text-8xl font-semibold uppercase leading-none -mb-6'
                    >
                        Opening
                    </motion.h1>
                </div>
                <motion.div 
                    ...
                    viewport={{once: true}}
                    className='logo absolute -bottom-8 cursor-pointer'
                >
            ...
            <div className='w-1/2 leading-none'>
                <div className='overflow-hidden'>
                    <motion.h1 
                        ...
                        viewport={{once: true}}
                        className='tracking-tighter -ml-3 text-8xl font-semibold uppercase leading-none -mb-3'
                    >
                        PRESENTATIONS
                    </motion.h1>
                </div>
                <div className='flex justify-between items-center'>
                    <div className='mt-14'>
                        ...
                        <div className='links flex flex-col mt-6 mb-6'>
                            {socialLinks.map((item, index) => (
                                <motion.a 
                                    key={index} 
                                    initial={{x: -20, opacity: 0}}
                                    whileInView={{x: 0, opacity: 1}}
                                    whileHover={{x: 5, color: "#CDEA68"}}
                                    transition={{
                                        duration: 0.4, 
                                        delay: 0.3 + index * 0.1,
                                        x: {
                                    ...
                                    viewport={{once: true}}
                                    className='underline text-lg capitalize font-light cursor-pointer'
                                >
                                    {item}
                                </motion.a>
                            ))}
                        ...
                        <div className='links flex flex-col mt-6 mb-6'>
                            {locationLinks.map((item, index) => (
                                <motion.a 
                                    ...
                                    viewport={{once: true}}
                                    className={`text-lg underline capitalize font-light cursor-pointer ${index===2 && "mt-8"}`}
                                >
                                    {item}
                                </motion.a>
                            ))}
                        ...
                        <motion.p 
                            ...
                            viewport={{once: true}}
                            className='mt-12 -mb-12 opacity-15 cursor-pointer'
                        >
                            © ochi design 2024. <span className='underline uppercase'>Legal Terms</span>
                        </motion.p>
                    </div>
                    <div className='relative'>
                        ...
                        <div className='links flex flex-col mt-6 mb-6'>
                            {menuLinks.map((item, index) => (
                                <motion.a 
                                    ...
                                    viewport={{once: true}}
                                    className='text-lg underline capitalize font-light cursor-pointer'
                                >
                                    {item}
                                </motion.a>
                            ))}
                        ...
                        <motion.p 
                            ...
                            viewport={{once: true}}
                            className='absolute -bottom-[34vh] w-[20vw] opacity-50 uppercase cursor-pointer'
                        >
                            Website by Raktim
                        </motion.p>
                    </div>
